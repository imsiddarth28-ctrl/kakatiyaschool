      ...
      <div className="pt-32 pb-16 bg-[#0C2340] text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl font-black font-heading tracking-tight text-white mb-4">
            Campus <span className="text-gradient-gold">Infrastructure & Facilities</span>
          </h1>
          <p className="text-slate-300 text-lg max-w-2xl">
            State-of-the-art STEM labs, 10-acre athletic complex, 4K smart classrooms, and safety transport systems.
          </p>
        </div>
      </div>
